...
def create_action2_parser(subparser):
  ...
  subaction1_parser = subparsers.add_parser("subaction1", help = "Run surreal_collage action2 subaction1")
  subaction1_parser.set_defaults(func=run_action2_subaction1)

  subaction2_parser = subparsers.add_parser("subaction2", help = "Run surreal_collage action2 subaction2")
...
def run_action2_subaction1(args):
  logger.info("You decided to run `surreal_collage action2 subaction1`")

def run_action2_subaction2(args):
  logger.info("You decided to run `surreal_collage action2 subaction2` with something=%s", args.something)
